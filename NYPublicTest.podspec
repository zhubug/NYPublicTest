...
Pod::Spec.new do |s|
  s.name             = 'NYPublicTest'
  s.version          = '0.1.0'
  s.summary          = 'A short description of NYPublicTest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhunanyang/NYPublicTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhunanyang' => 'zhunanyang@aliyun.com' }
  s.source           = { :git => 'https://github.com/zhunanyang/NYPublicTest.git', :tag => s.version.to_s }
